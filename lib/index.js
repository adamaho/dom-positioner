...
function getAnchorRegion(element) {
    let x;
    let y;
    const doc = element.ownerDocument;
...
bl  *-----*-----*  br
          bc
*/
function getAnchorPoint(anchorPoint, anchorRegion) {
...
function getFloaterPoint(anchorRegion, floaterRegion, anchorPoint, floaterPoint, isRelative) {
    // total diff
...
function calculateRelationPosition(anchorElement, floaterElement, position, isRelative) {
...
exports.getRelativePosition = (anchorElement, floaterElement, position, container) => {
    if (container) {
